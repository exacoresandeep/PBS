...
//	                ->orderBy('created_at', 'desc')
  ...
  //              ->get();
            ...
            $activity->assigned_date = date('d/m/Y', strtotime($activity->assigned_date));
	    $activity->completed_date = date('d/m/Y', strtotime($activity->completed_date));
	    return [
                    'id' => $activity->id,
...
//		    $user = Auth::user();
   ...
   $activity->assigned_date = date('d/m/Y', strtotime($activity->assigned_date));
        $activity->due_date = date('d/m/Y', strtotime($activity->due_date)); 
