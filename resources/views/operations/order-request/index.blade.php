...
<div class="activity-sec">
	...
	<div class="d-flex align-items-end mb-3">
        ...
        <div class="me-2">
        	<label for="vehicleStatusFilter" class="form-label">Yard Status:</label>
        	<select id="vehicleStatusFilter" class="form-select" style="width: 200px;">
...
<script>
       ...
       var table =  $('#ordersTable').DataTable({
            ...
            data: function (d) {
               d.status = $('#statusFilter').val(); 
                ...
                d.vehicle_status = $('#vehicleStatusFilter').val(); 
            }
        	},
	    columns: [
	...
	$('#statusFilter, #fromdate, #todate, #vehicleStatusFilter').on('change', function () {
            table.ajax.reload();
        });
    });
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        $('#view_remarks').val(order.view_remarks ?? 'NA');
...
$(document).on('click', '#submit_vehicle_status', function () {
    ...
    var orderId = $('#view_order_id').text().replace('OD00', ''); // Adjust ID logic as needed
